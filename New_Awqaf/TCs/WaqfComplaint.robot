...
${WaqfComplaint_FirstRB_RB}                        id=edit-is-under-awqaf-authority-yes
...
${WaqfComplaint_SecondRB_RB}                       id=edit-complaint-is-decided-no
${WaqfComplaint_ThirdRB_RB}                        id=edit-has-a-legal-ruling-been-issued-no
...
Submit_Waqf_Complaint
     ...
     Input Text                       ${WaqfComplaint_Explain_Text}                   تست
     Input Text                       ${WaqfComplaint_Required_Text}                  المطلوب
